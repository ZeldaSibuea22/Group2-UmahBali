                  ...
                  <div className="shadow-sm p-lg-4 p-md-3 p-3 bg-body rounded">
                    <form className="row gx-0 gy-5 gy-md-0 gx-lg-5 px-lg-4 align-items-center justify-content-between search-property-form">
                      ...
                      <div className="col-md-1 col-12 text-center">
                        <button className="btn btn-sm btn-main d-none d-md-block">
                          <i className="fas fa-search"></i>
                        </button>
                        <button className="btn btn-sm btn-main d-block d-md-none">
      ...
      <section>
        <div className="container py-5 mt-5">
          ...
          <div className="row mt-1 gx-0 gy-4 gx-md-4">
            ...
            <div className="col-md-6 col-xl-4">
              <Card
                src="https://images.unsplash.com/photo-1522050212171-61b01dd24579?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=880&q=80"
                top="Rumah"
                nama="Townhouse Bagus 2 Lantai"
                lokasi="Jimbaran, Badung"
                harga="IDR. 600 M"
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-xl-4">
                  <Card
                    src="https://images.unsplash.com/photo-1512915922686-57c11dde9b6b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80"
                    top="Rumah"
                    nama="Ruko Bagus Asri"
                    lokasi="Jimbaran, Badung"
                    harga="IDR. 600 M"
                    agen="Futurehomy Agency"
                    href="/searchProperty/2"
                  />
                </div>
              </div>
            </div>
