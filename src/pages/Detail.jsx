                    ...
                    <div className="container">
                        ...
                        <div className="container mt-4 mb-5">
                            ...
                            <div className="d-flex d-block mb-2" style={{ color: 'grey' }}>
                                <h6 className="me-4"><i class="fas fa-home"></i> 1m2</h6>
                            ...
                            <div className="row g-2" id="lightgallery">
                                <div className="col-12 col-lg-6">
                                    <a className="image-tile" href="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_600/https://www.fujihomejapan.com/wp-content/uploads/2018/11/Renon_7.jpg" data-abc="true" >
                                        <img className="img-fluid" style={{ borderTopLeftRadius: '3%', borderBottomLeftRadius: '3%', height: '100%' }} src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_600/https://www.fujihomejapan.com/wp-content/uploads/2018/11/Renon_7.jpg" alt="ini gambar" />
                                    </a>
                                </div>
                                    ...
                                    <div className="row gy-2">
                                        <div className="col-lg-6">
                                            <a class="image-tile" href={context.img[1]} data-abc="true" >
                                                <img className="img-fluid" src={context.img[1]} alt="ini gambar juga" style={{ objectFit: 'cover', height: '300px', width: '100%' }} />
                                            </a>
                                        </div>
                                        <div className="col-6 d-none d-lg-block">
                                            <a class="image-tile" href={context.img[2]} data-abc="true" >
                                                <img className="img-fluid" style={{ borderTopRightRadius: '3%', height: '300px', width: '100%', objectFit: 'cover' }} src={context.img[2]} alt="ini gambar jugaaa" />
                                            </a>
                                        </div>
                                        <div className="col-6 d-none d-lg-block">
                                            <a class="image-tile" href={context.img[3]} data-abc="true" >
                                                <img className="img-fluid" src={context.img[3]} alt="ini gambar juga" style={{ objectFit: 'cover', height: '300px', width: '100%' }} />
                                            </a>
                                        </div>
                                        <div className="col-6 position-relative d-none d-lg-block">
                                            <a class="image-tile" href={context.img[4]} data-abc="true" >
                                                <img className="img-fluid" style={{ borderBottomRightRadius: '3%', filter: 'blur(2px)', objectFit: 'cover', height: '300px', width: '100%' }} src={context.img[4]} alt="ini gambar juga" />
                                            </a>
